package com.msgs.domain.mypage.dao;
...
@Repository
public interface MyPageDAO extends JpaRepository<User, Integer>{
//
//    @Query("SELECT new com.msgs.domain.mypage.dto.MyPageScheduleDTO(u, ts) " +
//            "FROM User u " +
//            "JOIN u.trip ts " +
//            "WHERE u.id = :id")
...
//    @Query("SELECT new com.msgs.domain.mypage.dto.MyPageReviewDTO(u, pr) " +
//            "FROM User u " +
//            "JOIN u.destinationReviews pr " +
//            "WHERE u.id = :id")
//    List<MyPageReviewDTO> findMyPageTripLocReview(@Param("id") String id);
//
//    @Query("SELECT new com.msgs.domain.dto.mypage.MyPageUserDTO(u) " +
//            "FROM User u " +
//            "WHERE u.id = :id")
...
//    @Query("SELECT new com.msgs.domain.dto.mypage.MyPageUserDTO(ue, ui) " +
//            "FROM User u " +
//            "JOIN u.userImg ui " +
//            "WHERE u.id = :id")
